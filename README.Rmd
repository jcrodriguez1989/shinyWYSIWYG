...
ShinyWYSIWYG is currently only available as a GitHub package. To install it run
...
Or visit the [example app](https://jcrodriguez.shinyapps.io/shinyWYSIWYG/)
at shinyapps.io

## Example

Watch the [example video](https://youtu.be/mfEwWn2mxpU) of how to create a Shiny
app with ShinyWYSIWYG.
